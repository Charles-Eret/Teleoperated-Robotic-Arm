...
class Dynamixel:
    ...
    def read_velocity_limit(self, motor_id: int):
        return self._read_value(motor_id, ReadAttribute.ADDR_VELOCITY_LIMIT, 4)
    ...
    def set_velocity_limit(self, motor_id: int, velocity_limit):
        ...
        print(f"Motor ID: {motor_id}, dxl_comm_result: {dxl_comm_result}, dxl_error: {dxl_error}")  # Debugging line
        self._process_response(dxl_comm_result, dxl_error, motor_id)
